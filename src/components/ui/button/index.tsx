...
export interface ButtonProps
  extends Omit<ComponentProps<typeof LedgerButton>, "variant" | "size"> {
...
/** Dispatch hero CTA radius — rounded-lg mobile, rounded-xl desktop. */
export const dispatchHeroButtonRadiusClass = "rounded-button-sm lg:rounded-button-lg";
